...
│ ┌────────┴────────┐ ┌────────┴────────┐ ▼ ▼ ▼ ▼ PROGRESSÃO TEMPOS VERBAIS EXPOSITIVO ARGUMENTATIVO TEMPORAL PREDOMINANTES (Impessoal / (Defesa de tese (Sucessão de • Pretérito Perfeito Sem persuasão) pessoal autoral) ações em antes • Presente Histórico │ e depois) ┌────────┴────────┐ ▼ ▼ EXPOSITIVO EXPOSITIVO- PURO INFORMATIVO (Conceitos (Apresenta gerais) NOVIDADES)
