...
│ ┌───────────┴───────────┐ ┌───────────┼───────────┐ ▼ ▼ ▼ ▼ ▼ PROVER REQUERER CABER CRER HAVER (Pres: VER / (Geral: BEBER / (caibo -> (cri/creu; (Anômalo; Demais: BEBER) Pres: ditongo EI) caiba) crido) houve) │ │ │ │ │ [vs. PROVIR = VIR] [≠ QUERER] └─────┬─────┴─────┬─────┘ │
│ ▼ ▼ APRAZER IR / ADERIR (Defectivo; (IR: ides/vades; Líder: HAVER) ADERIR = FERIR)
