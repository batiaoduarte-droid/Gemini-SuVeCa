...
│ ┌────────────────────────────┴────────────────────────────┐ ▼ ▼ [1. Divisão Silábica Fonética] [2. Varredura de Dígrafos] • Falar pausadamente (Abertura de boca) • Dígrafos consonantais (CH, RR, SS, SC...) • Consoante sem vogal recua (af-ta) • Grupos QU/GU (U é mudo?) • Dígrafos separáveis vs. inseparáveis • Dígrafos vocálicos (Vogal + M/N na sílaba) │ │ └────────────────────────────┬────────────────────────────┘ ▼ [3. Encontros Vocálicos e Consonantais] • Letras mudas consom-se no dígrafo • V + SV = Ditongo Decrescente (DD) • SV + V = Ditongo Crescente (DC) • V | V = Hiato (H) • Consoantes audíveis = Encontro Consonantal (EC)
