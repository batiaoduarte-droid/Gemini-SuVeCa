...
│ ┌─────────────────────────┴─────────────────────────┐
│ ▼ ▼ │ [ PASSIVA ANALÍTICA ] [ PASSIVA SINTÉTICA ] │ • Locução: SER + Particípio • Morfossintaxe: VTD/VTDI + SE │ • Agente: Expresso ou Indeterminado • Agente: Indeterminado (não inexistente) │ • Extensão: +1 verbo que a ativa • Economia: Sem auxiliar / Sem agente │ │ │ │ └────────────── Transposição Mútua ─────────────────┘ │ (Método 4 Instruções) │ └──────────────────────────────────────── Conversão Mútua ────────────────────┘ (Atalho: Corta SE + 3ª Plural)
```
