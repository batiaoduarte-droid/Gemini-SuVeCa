...
│ ┌────────┴────────┐ ┌────────┴────────┐ ┌────────┴────────┐ │ Artigo Distante │ │ ARTIGO DEFINIDO │ │ PRONOME PESSOAL │ │ (Adjetivo meio) │ │ • Anáfora textual │ (Troca por ela) │ └────────┬────────┘ │ • Conhecimento │ └────────┬────────┘ │ │ de mundo │
│ ┌────────┴────────┐ └────────┬────────┘ ┌────────┴────────┐ │ Subst. Implícito│ │ │ PREPOSIÇÃO │ │ (Elipse textual)│ ┌────────┴────────┐ │ (Conectivo / VTI│ └────────┬────────┘ │ARTIGO INDEFINIDO│ │ ou Nominal) │ │ │ • Realidade vaga│ └────────┬────────┘ ┌────────┴────────┐ │ • Não exclusiva │ │ │ CONTRAÇÕES │ │ (uma dentre
│ ┌────────┴────────┐ │ DA, DO, NA, NO, │ │ várias) │ │ PRON. DEMONSTR. │ │ PELO, PELA... │ └─────────────────┘ │ (Antes de QUE/DE│ └─────────────────┘ │ = Aquele/Aquilo│ └─────────────────┘
```
